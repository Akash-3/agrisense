...
def generate_full_8000_word_report(output_docx_path):
    doc = Document()
    
    # 1. Standard Page Setup (1.5 Line Spacing, 1 inch Margins)
    ...
    add_p("The research work and engineering implementation presented in this report have been conducted under internal faculty supervision within the Department of Information Technology. The embedded firmware, multi-spectral sensor signal processing algorithms, microservice architecture endpoints, deep learning neural network topologies, and interactive web dashboard components have been evaluated for technical correctness, functional completeness, and academic rigor.", bold_prefix="System Verification & Technical Evaluation:")
    ...
    file_full = os.path.join(out_dir, "AgriSense_Full_8000_Report.docx")
    doc.save(file_full)
    print(f"Successfully generated Report Word Document at: {file_full}")

    try:
        doc.save(output_docx_path)
        print(f"Successfully saved to master path: {output_docx_path}")
    except Exception as e:
        print(f"Notice: Master file locked by Word ({e}). Saved primary file as AgriSense_Full_8000_Report.docx")
...
if __name__ == "__main__":
    ...
    generate_full_8000_word_report(master_docx_path)
