...
def generate_synopsis_with_top_banner_only(docx_path, md_path):
    print(f"Building AgriSense Project Synopsis with top banner box on Page 1 at {docx_path}...")
    doc = Document()
    
    # Configure page setup (Single section, no cover page, 1 inch margins)
    sec = doc.sections[0]
    ...
    r1.font.size = Pt(24)
    r1.font.bold = True
    r1.font.color.rgb = RGBColor(0x0F, 0x17, 0x2A) # Slate Dark
    ...
    r2.font.name = 'Arial'
    r2.font.size = Pt(12)
    r2.font.color.rgb = RGBColor(0x1E, 0x3A, 0x8A) # Deep Blue
    ...
    # Right-aligned Authors (matching image)
    authors = [
    ...
    doc.save(docx_path)
    print(f"Successfully generated AgriSense Synopsis with top banner header at: {docx_path}")
...
if __name__ == "__main__":
    ...
    generate_synopsis_with_top_banner_only(syn_docx_path, syn_md_path)
