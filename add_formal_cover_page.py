...
def generate_synopsis_with_cover(docx_path, md_path):
    print(f"Building AgriSense Project Synopsis with formal cover page at {docx_path}...")
    doc = Document()
    
    # Configure default section (Cover Page)
    ...
    # Ensure cover page footer is blank
    ...
    # Section 2 for Body (with page numbers in footer)
    ...
    doc.save(docx_path)
    print(f"Successfully saved AgriSense Project Synopsis DOCX with formal cover page at: {docx_path}")
...
if __name__ == "__main__":
    ...
    generate_synopsis_with_cover(syn_docx_path, syn_md_path)
    
    # Copy to OneDrive
    onedrive_syn = r"C:\Users\tempm\OneDrive\Documents\AgriSense_Project_Synopsis.docx"
    shutil.copy(syn_docx_path, onedrive_syn)
    print(f"Copied updated synopsis with formal cover page to OneDrive: {onedrive_syn}")
